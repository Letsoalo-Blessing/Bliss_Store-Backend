                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="delete_product.php">Product</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Product in Stock</strong>
                    </div>
                        ...
                        <table class="table table-dark">
                            ...
                            <tbody>
                                ...
                                <tr>            
                                    ...
                                    <td><?php echo $Qty?></td>
                                    <td><span>R </span><?php echo $unitPrice?></td>
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="delete_product.php?delete=<?php echo $prod_id?>" value="Delete">Delete</a>                   
                                    </td>
                                    ...
                                    <?php
                                        ...
                                        if(isset($_GET['delete'])){
                                            ...
                                            mysqli_query($conn,"DELETE FROM tblproduct WHERE prodID='$delete_id'");
                                        }
                                    ?>
